...
/** An implementation of the ExtrinsicMinPQ using heap. You may find it very similar to NaiveMinPQ, but
...
public class ArrayHeapMinPQ<T> implements ExtrinsicMinPQ<T> {
    ...
    private boolean compare(int index1, int index2) {return items.get(index1).compareTo(items.get(index2)) < 0;}
